...
const AddCreator = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (imageURL) insertObject.imageURL = imageURL;
    if (description) insertObject.description = description;
    if (youtubeHandle) insertObject.youtubeURL = `https://www.youtube.com/user/${youtubeHandle}`;
    if (twitterHandle) insertObject.twitterURL = `https://x.com/${twitterHandle}`;
    if (instagramHandle) insertObject.instagramURL = `https://www.instagram.com/${instagramHandle}`;
    if (tiktokHandle) insertObject.tiktokURL = `https://www.tiktok.com/@${tiktokHandle}`;
